                ...
                <div class="app-card-body px-4 w-100">
                    <form action="<?= base_url('admin/profil/proses_edit'); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <img width="150px" class="img-thumbnail" src="<?= base_url('assets/img/' . esc($profil_pengguna['logo_perusahaan'] ?? 'default.png')); ?>">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <img width="150px" class="img-thumbnail" src="<?= base_url('assets/img/' . esc($profil_pengguna['favicon_perusahaan'] ?? 'default.png')); ?>">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <img width="150px" class="img-thumbnail" src="<?= base_url('assets/img/' . esc($profil_pengguna['foto_perusahaan'] ?? 'default.png')); ?>">
                        </div>
